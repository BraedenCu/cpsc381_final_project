...
Streams processed frames to browser using MJPEG.
"""
import os
import datetime
import cv2
...
# rolling buffer and preprocessing
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Live Wave Detection</title>
  </head>
  <body>
    <h1>Wave Detection Feed</h1>
